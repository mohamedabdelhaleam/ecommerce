        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ __('dashboard.create_new_product') }} - Step 1 of 3: Basic Information</h6>
                </div>
                <div class="card-body">
                    <!-- Step Indicator -->
                            ...
                            <ul class="nav">
                                ...
                                <li class="dm-steps__item" onclick="goToStep(2)" style="cursor: pointer;">
                                    ...
                                    <div class="dm-steps__content">
                                        ...
                                        <span class="dm-steps__text">Add Variants</span>
                                    </div>
                                </li>
                                <li class="dm-steps__item" onclick="goToStep(3)" style="cursor: pointer;">
                                    <div class="dm-steps__content">
                                        ...
                                        <span class="dm-steps__text">Add Images</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <form id="step1Form" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-25">
                                        ...
                                        <textarea class="form-control @error('description_en') is-invalid @enderror" id="description_en"
                                            name="description_en" rows="4">{{ old('description_en') }}</textarea>
                            ...
                            <div class="form-group mb-0 d-flex gap-2 align-items-center justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    Next: Add Variants <i class="uil uil-arrow-right"></i>
                                </button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div id="step2" class="step-content" style="display: none;">
                        <form id="step2Form">
                            ...
                            <div class="form-group mb-0 d-flex gap-2 align-items-center justify-content-between">
                                ...
                                <div>
                                    <button type="submit" class="btn btn-primary">
                                        Next: Add Images <i class="uil uil-arrow-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div id="step3" class="step-content" style="display: none;">
                        ...
                        <div class="form-group mb-0 d-flex gap-2 align-items-center justify-content-between mt-4">
                            ...
                            <button type="button" class="btn btn-success" id="completeBtn">
                                <i class="uil uil-check"></i> Complete Product Creation
                            </button>
                        </div>
                    </div>
                </div>
...
@section('script')
    <script>
        ...
        function updateStepIndicator(step) {
            ...
            steps.forEach((item, index) => {
                ...
                if (stepNum < step) {
                    ...
                    icon.innerHTML = `<span class="dm-steps__count">${stepNum}</span>`;
                    // Only allow clicking if product is created (for step 2 and 3)
                    if (stepNum === 2 || stepNum === 3) {
                        item.style.cursor = productId ? 'pointer' : 'not-allowed';
                    } else {
                        item.style.cursor = 'pointer';
                    }
                }
        ...
        function skipStep(step) {
            if (step === 2) {
                if (confirm('Skip adding variants? You can add them later.')) {
                    showStep(3);
                    loadImagesStep();
                }
            }
        ...
        function addVariantRow(colorId = '', sizeId = '', price = '', stock = '') {
            const container = document.getElementById('variantsContainer');
            const variantHtml = `
                <div class="card mb-3 variant-row" data-variant-index="${variantCount}">
                    <div class="card-body">
        ...
        document.getElementById('step2Form').addEventListener('submit', function(e) {
            ...
            if (!productId) {
                alert('Product ID not found. Please go back to step 1.');
                return;
            }
            ...
            if (savedColors.length > 0) {
                ...
                imagesContainer.innerHTML = savedColors.map(color => `
                    <div class="card mb-3 color-image-section" data-color-id="${color.id}">
                        <div class="card-header">
                            <h6 class="mb-0">Images for: ${color.name}</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="uploaded-images-${color.id} mt-3 row"></div>
                        </div>
                    </div>
                `).join('');
            } else {
        ...
        // Step 3: Image Upload (removed - images now upload on completeBtn click)
        ...
        document.getElementById('completeBtn').addEventListener('click', async function() {
            ...
            try {
                ...
                if (confirm('Images uploaded successfully! Complete product creation?')) {
