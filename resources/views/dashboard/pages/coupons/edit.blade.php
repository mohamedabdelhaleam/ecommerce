        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ __('dashboard.edit_coupon') }}</h6>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('dashboard.coupons.update', $coupon) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-25">
                                    ...
                                    <input type="text" class="form-control @error('name_ar') is-invalid @enderror"
                                        id="name_ar" name="name_ar" value="{{ old('name_ar', $coupon->name_ar) }}"
                                        required>
                                    @error('name_ar')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-25">
                                    ...
                                    <input type="text" class="form-control @error('name_en') is-invalid @enderror"
                                        id="name_en" name="name_en" value="{{ old('name_en', $coupon->name_en) }}">
                                    @error('name_en')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-25">
                                    ...
                                    <textarea class="form-control @error('description_ar') is-invalid @enderror" id="description_ar"
                                        name="description_ar" rows="3">{{ old('description_ar', $coupon->description_ar) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-25">
                                    ...
                                    <textarea class="form-control @error('description_en') is-invalid @enderror" id="description_en"
                                        name="description_en" rows="3">{{ old('description_en', $coupon->description_en) }}</textarea>
                        ...
                        <div class="form-group mb-0 d-flex gap-2 align-items-center">
                            <button type="submit" class="btn btn-primary">
                                <i class="uil uil-save"></i> {{ __('dashboard.update') }} {{ __('dashboard.coupon') }}
                            </button>
