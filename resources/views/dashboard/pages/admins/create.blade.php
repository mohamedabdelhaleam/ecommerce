        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ __('dashboard.create_new_admin') }}</h6>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('dashboard.admins.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-25">
                                    <label for="password" class="form-label">{{ __('dashboard.password') }}
                                        <span class="text-danger">*</span></label>
                                    ...
                                    @error('password')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">{{ __('dashboard.password_min_8') }}</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-25">
                                    <label for="password_confirmation"
                                        class="form-label">{{ __('dashboard.confirm_password') }}
                                        <span class="text-danger">*</span></label>
                                    <input type="password"
                        ...
                        <div class="form-group mb-0 d-flex gap-2 align-items-center">
                            <button type="submit" class="btn btn-primary">
                                <i class="uil uil-save"></i> {{ __('dashboard.create') }} {{ __('dashboard.admin') }}
                            </button>
