        ...
        <div class="col-lg-12 mb-30">
            <div class="card">
                <div class="card-header color-dark fw-500 d-flex justify-content-between align-items-center">
                    <span>{{ __('dashboard.size_list') }}</span>
                    <a href="{{ route('dashboard.sizes.create') }}" class="btn btn-primary btn-sm">
                        <i class="uil uil-plus"></i> {{ __('dashboard.add_new_size') }}
                    </a>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-12">
                            <form id="size-search-form" class="row g-3"
                                data-search-url="{{ route('dashboard.sizes.index') }}">
                                <div class="col-md-4">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0 table-borderless">
                                        ...
                                        <th>
                                            <div class="d-flex align-items-center">
                                                <div class="custom-checkbox check-all">
                                                    <input class="checkbox" type="checkbox" id="check-all-sizes">
                                                    <label for="check-all-sizes">
                                                        <span
                                                            class="checkbox-text userDatatable-title">{{ __('dashboard.size') }}</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title">{{ __('dashboard.value') }}</span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title">{{ __('dashboard.order') }}</span>
                                        </th>
                                        <th>
                                ...
                                <tbody id="sizes-table-body">
                                    @include('dashboard.pages.sizes.partials.table')
                                </tbody>
                            </table>
                        </div>
                    </div>
