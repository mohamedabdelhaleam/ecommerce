        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ __('dashboard.create_new_color') }}</h6>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('dashboard.colors.store') }}" method="POST">
                                ...
                                <div class="form-group mb-25">
                                    ...
                                    <div class="input-group">
                                        <input type="color"
                                            ...
                                            id="hex_code_color" value="{{ old('hex_code', '#000000') }}"
                                            title="Choose color">
                        ...
                        <div class="form-group mb-0 d-flex gap-2 align-items-center">
                            <button type="submit" class="btn btn-primary">
                                <i class="uil uil-save"></i> {{ __('dashboard.create') }} {{ __('dashboard.color') }}
                            </button>
