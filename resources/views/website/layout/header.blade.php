<header
    ...
    <div class="flex flex-1 justify-center px-8">
        <label class="flex flex-col w-full !h-10 max-w-md">
            <div class="flex w-full flex-1 items-stretch rounded-xl h-full">
                <div
                    class="text-gray-500 dark:text-gray-400 flex border-none bg-background-light dark:bg-background-dark items-center justify-center pl-4 rounded-l-xl border-r-0">
